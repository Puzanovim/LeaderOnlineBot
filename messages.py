...
questions = {
    ...
    28: {
        ...
        "Choices": ["ЕГИС - Единая ... автоматизированная ...  ... , предназначенная для государственного контроля над объёмом производства и оборота этилового спирта (но ответ во множественном числе)"],
...
institutes = {
    ...
    "ИнЭУ":     ["Взаимодействие государства и бизнеса в условиях цифровой трансформации (https://openedu.ru/course/urfu/GOVBUSINESS/)",
                 ...
                 "Основы личностного роста (для лиц с ОВЗ) (https://openedu.ru/course/urfu/Inclus_M1/)",
                 "Развитие ресурсов организма (для лиц с ОВЗ) (https://openedu.ru/course/urfu/Inclus_M2/)"],
    "ИФКСиМП":  ["Основы личностного роста (для лиц с ОВЗ) (https://openedu.ru/course/urfu/Inclus_M1/)",
                 "Развитие ресурсов организма (для лиц с ОВЗ) (https://openedu.ru/course/urfu/Inclus_M2/)"],
